...
use App\Http\Controllers\{ActivityLogController, AuthController, CategoryController, DashboardController, ItemController, LoanController, ReportController, ReturnController, UserController};
...
Route::middleware('auth')->group(function () {
    ...
    Route::post('/loans/{id}/cancel', [LoanController::class, 'cancel'])->name('loans.cancel');
    ...
    Route::get('/loans/{id}/reupdate', [LoanController::class,'reupdateLoan'])->name('loans.reupdate');
    Route::put('/loans/{id}/resubmit', [LoanController::class,'resubmitLoan'])->name('loans.resubmit');
